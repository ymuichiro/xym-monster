...
export function instanceOfVrfKeyLinkTransactionDTO(value) {
    let isInstance = true;
...
export function VrfKeyLinkTransactionDTOFromJSON(json) {
    return VrfKeyLinkTransactionDTOFromJSONTyped(json, false);
}
export function VrfKeyLinkTransactionDTOFromJSONTyped(json, ignoreDiscriminator) {
...
export function VrfKeyLinkTransactionDTOToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
