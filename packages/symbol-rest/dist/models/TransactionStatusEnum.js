...
export function TransactionStatusEnumFromJSON(json) {
    return TransactionStatusEnumFromJSONTyped(json, false);
}
export function TransactionStatusEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function TransactionStatusEnumToJSON(value) {
    return value;
}
